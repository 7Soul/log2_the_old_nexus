...
defineObject{
	...
	components = {
		...
		},
		{
			...
			cooldown = 4.5,
			swipe = "vertical",
			requirements = { "heavy_weapons_c", 1 },
		},
		{
			class = "MeleeAttack",
			name = "stun",
...
defineObject{
	...
	components = {
		...
		},
		{
			...
			impactSound = "impact_blade",
			weight = 2.4,
			traits = { "light_weapon", "mace", "bite", "dismantle", "upgradable", "poison_mace" },
...
defineObject{
	...
	components = {
		...
		},
		{
			...
			impactSound = "impact_blunt",
			weight = 6.5,
			traits = { "heavy_weapon", "mace", "stun", "dismantle", "upgradable" },
			secondaryAction = "stun",
		},
		{
			class = "MeleeAttack",
...
defineObject{
	...
	components = {
		...
		},
		{
			...
			impactSound = "impact_blunt",
			weight = 6.0,
			traits = { "heavy_weapon", "two_handed", "mace", "knockback", "dismantle", "upgradable", "epic" },
			secondaryAction = "knockback",
		},
		{
			class = "MeleeAttack",
			attackPower = 29,
...
defineObject{
	...
	components = {
		...
		},
		{
			...
			power = 5,
			charges = 9,
			requirements = { "heavy_weapons_c", 5, "concentration", 1 },
		},
		{
			class = "Particle",
